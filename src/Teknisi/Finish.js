...
import {Link_complete,token} from '../style/Link';
...
isLoading(true);
if (lat !='' || lon !='') {*/
if (imagemime == null || desc =='' || incident_id =='' || solusi =='' || hasil =='') 
...
fetch(Link_complete, 
        {
          ...
          clean_cache();
           ...
           navigation.replace('Ttd',{incident_id:incident_id});
...
style={{width:245,height:330,borderWidth:2,borderColor:'#5DCAED',resizeMode:'contain'}}/>
  ...
  <Text style={{color:'grey',fontSize:16,fontWeight:'bold',textAlign:'left',marginVertical:5}} >Deskripsi Foto</Text>
    ...
    />
     ...
     <Text style={{color:'grey',fontSize:16,fontWeight:'bold',textAlign:'left',marginVertical:5}} >Hasil Pekerjaan</Text>
           <TextInput style={styles.inputBox}
      placeholder="Hasil"
      spellCheck={false}
      autoCorrect={false}
    ...
    />
     ...
     <Text style={{color:'grey',fontSize:16,fontWeight:'bold',textAlign:'left',marginVertical:5}} >Solusi Pekerjaan</Text>
           <TextInput style={styles.inputBox}
      placeholder="Solusi"
      spellCheck={false}
      autoCorrect={false}
      numberOfLines={4}
      multiline = {true}
      onChangeText={value => setSolusi(value)}
    />
{/*
        <Text style={{color:'grey',fontSize:16,fontWeight:'bold',textAlign:'left',marginVertical:5}} >Biaya Perbaikan</Text>
           <TextInput style={styles.inputBox}
      placeholder="total"
      spellCheck={false}
      autoCorrect={false}
