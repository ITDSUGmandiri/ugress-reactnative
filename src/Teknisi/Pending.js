...
import {Link_pending,token} from '../style/Link';
...
style={{width:245,height:330,borderWidth:2,borderColor:'#5DCAED',resizeMode:'contain'}}/>
  ...
  <Text style={{color:'grey',fontSize:16,fontWeight:'bold',textAlign:'left',marginVertical:5}} >Deskripsi Foto</Text>
    ...
    />
     ...
     <Text style={{color:'grey',fontSize:16,fontWeight:'bold',textAlign:'left',marginVertical:5}} >Catatan Pending</Text>
           <TextInput style={styles.inputBox}
      placeholder="Deskripsi"
      spellCheck={false}
      autoCorrect={false}
...
<TouchableOpacity style={styles.button} 
       onPress={() => Simpan()}
       activeOpacity={0.6}>
<Text style={styles.buttonText}>Submit Pending</Text>
</TouchableOpacity> 
</View>
        </View>
    )
