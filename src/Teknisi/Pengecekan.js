...
import {Link_pengecekan,token} from '../style/Link';
...
fetch(Link_pengecekan, 
        {
          ...
          clean_cache();
           isLoading(false);
           navigation.replace('Teknisi_progres',{incident_id:responseJson.tiket});
...
<TouchableOpacity style={styles.button} 
       onPress={() => Simpan()}
       activeOpacity={0.6}>
<Text style={styles.buttonText}>Submit Pengecekan</Text>
</TouchableOpacity> 
</View>
        </View>
    )
